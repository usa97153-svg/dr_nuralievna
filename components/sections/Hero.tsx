        ...
        <div className="relative">
          ...
          {floatCards.map((card, i) => (
            <motion.div
              ...
              className={`hidden sm:flex absolute ${card.className} max-w-[230px] items-start gap-3 rounded-2xl bg-white/95 backdrop-blur-sm border border-bordersoft shadow-lg px-4 py-3.5 cursor-default`}
            >
          ...
          {/* Mobile: simple list of cards below the photo (no overlap) */}
          <div className="sm:hidden mt-6 space-y-3">
            {floatCards.map((card, i) => (
              <motion.div
                ...
                className="flex items-start gap-3 rounded-2xl bg-white/95 border border-bordersoft shadow-sm px-4 py-3.5"
              >
                <span className="mt-0.5 flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-gold/15">
                  <CardIcon name={card.icon} />
                </span>
