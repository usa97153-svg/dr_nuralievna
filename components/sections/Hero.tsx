...
const floatCards = [
  {
    ...
    className: "-left-1 top-[28%] sm:left-0 lg:-left-4",
    delay: 0.15,
  },
  {
    icon: "sparkles",
    ...
    className: "-right-1 top-[2%] sm:right-0 lg:-right-2",
    delay: 0.3,
  },
  {
    icon: "heart",
    ...
    className: "-right-1 top-[36%] sm:right-0 lg:-right-6",
    delay: 0.45,
  },
  {
    icon: "calendar",
    ...
    className: "-left-1 top-[58%] sm:left-2 lg:-left-2",
    delay: 0.6,
  },
  {
    icon: "shield",
    ...
    className: "-right-1 top-[68%] sm:right-2 lg:-right-4",
    delay: 0.75,
  },
];

function CardIcon({ name, className }: { name: string; className?: string }) {
  const cls = className ?? "w-5 h-5 text-gold-dark";
  switch (name) {
    case "sparkles":
        ...
        <div className="relative">
          ...
          {floatCards.map((card, i) => (
            <motion.div
              ...
              className={`flex absolute ${card.className} max-w-[150px] sm:max-w-[230px] items-start gap-2 sm:gap-3 rounded-xl sm:rounded-2xl bg-white/95 backdrop-blur-sm border border-bordersoft shadow-lg px-2.5 py-2 sm:px-4 sm:py-3.5 cursor-default`}
            >
              <span className="mt-0.5 flex h-6 w-6 sm:h-9 sm:w-9 shrink-0 items-center justify-center rounded-full bg-gold/15">
                <CardIcon name={card.icon} className="w-3.5 h-3.5 sm:w-5 sm:h-5 text-gold-dark" />
              </span>
              <span>
                <span className="block text-[11px] sm:text-sm font-semibold text-brown leading-snug">
                  {card.title}
                </span>
                <span className="hidden sm:block text-xs text-graytext leading-snug mt-0.5">
                  {card.text}
                </span>
              </span>
            </motion.div>
